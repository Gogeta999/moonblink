...
class UpdatePartnerProfilePage extends StatefulWidget {
  ...
  @override
  _UpdatePartnerProfilePageState createState() => _UpdatePartnerProfilePageState();
}
              ...
              children: <Widget>[
                ...
                LoginFormContainer(
                  child: Column(
                    ...
                    // _space,
                    UpdateProfileButton(cover: _cover, profile: _profile, bios: _biosController.text,)
                    ],
                  ),
                )
              ],
...
class PartnerCoverWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if(this.cover == null){
      return Image.asset(ImageHelper.wrapAssetsImage('images.jpg'), fit: BoxFit.cover,);
    } else {
      return Image.file(cover, filterQuality: FilterQuality.medium, fit: BoxFit.cover,);
    }
  }
}
///[Change Image.file (ImagePicker get File format)]
class PartnerProfileWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if(this.profile == null){
      ...
      return Image.file(this.profile, fit: BoxFit.cover,);
    }
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return LoginButtonWidget(
      ...
      child: model.isBusy
             ...
             : Text('Update Profile', style: Theme.of(context)
                                            .accentTextTheme
                                            .button
